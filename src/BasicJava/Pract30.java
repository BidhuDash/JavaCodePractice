...
public class Pract30 {
    public static void main(String[] args) {
        ...
        String a = "This is BasicJava.BasicJava.A String";
        ...
        //String format
        System.out.printf("The string is a is :- %s%n", a);
        //returns the String in a formated way
        System.out.printf("the output of hex code in integer %x%n", 9);
        System.out.printf("The fomate be like %s@%s%n", "bidhu", "Dash");
        System.out.printf("The decimal string would be like:-%16.9h%n", 345.5678); //%h - hex code
        ...
        System.out.println(a.indexOf("BasicJava.BasicJava.A")); // returns the index of the given character or occurance in the given string
        ...
        //System.out.println(a.replace('BasicJava.BasicJava.A','a'));
        ...
        System.out.println(c);  //returns th value of the string object in string
