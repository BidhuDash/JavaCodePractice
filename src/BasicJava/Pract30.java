...
public class Pract30 {
    public static void main(String[] args) {
        ...
        String a = "This is BasicJava.A String";
        ...
        System.out.println(a.indexOf("BasicJava.A")); // returns the index of the given character or occurance in the given string
        ...
        //System.out.println(a.replace('BasicJava.A','a'));
